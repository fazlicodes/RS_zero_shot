...
DATA=data
TRAINER=LaFTer
CFG=GeoRSCLIP #'vit_b32' or 'GeoRSCLIP' or 'RemoteCLIP' or 'EVA02_CLIP_B_psz16_s8B'
dset="$1"
txt_cls=lafter
nos_epochs=50
...
--output-dir output_and_pl1-avg_and_ln_frozen/${TRAINER}/${CFG}/"${dset}"_"${nos_epochs}"/"${bws}" \
--lr 0.0005 \
--epochs ${nos_epochs} \
--txt_cls ${txt_cls} \
--batch_size 50 \
